...
import { ShieldAlert, BookOpen, Clock, CheckCircle2, Play, Activity } from 'lucide-react';
            ...
            <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 shadow-2xl border border-slate-100 dark:border-slate-800 relative z-10 flex flex-col h-[500px]">
                ...
                {step === 2 && (
                    <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed flex-1">
                            Use the quick-tap milestone buttons to log ROM, Crowning, and Placenta delivery. Start the Head Out and Body Out timers to instantly track the progression of the delivery.
                        </p>
                ...
                {step === 3 && (
                    <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed flex-1">
                            Once the 'Body Out' timer is started, the app automatically tracks your 1-minute and 5-minute APGAR intervals. It will chime and flash the screen when it's time to log the scores.
                        </p>
