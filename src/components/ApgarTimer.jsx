...
export const ApgarTimer = () => {
    ...
    }, [bodyOutTimes, audioMode, playChime, speakTime, APGAR_CONFIG]);
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col">
                            ...
                            <span className={`font-black text-xl tracking-tighter ${getTextColor(apgar1MinParams)}`}>
                                {formatStatus(APGAR_CONFIG.INTERVAL_1, elapsed, apgar1MinParams)}
                            </span>
                        </div>
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex flex-col">
                            ...
                            <span className={`font-black text-xl tracking-tighter ${getTextColor(apgar5MinParams)}`}>
                                {formatStatus(APGAR_CONFIG.INTERVAL_2, elapsed, apgar5MinParams)}
                            </span>
                        </div>
